     ...
     <div class="mainwrap"> 
      <div class="think-form"> 
       ...
       <div class="login-other"> 
        <form name="frm" class="form-horizontal" role="form" action="${pageContext.request.contextPath}/UserServlet?type=register" method="post"> 
         ...
         <div class="control-group"> 
          ...
          <div class="controls"> 
          <img id="CreateCheckCode" src="ImageServlet">
